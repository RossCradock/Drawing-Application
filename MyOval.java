/*
Ross Cradock.
Class MyOval to create instance of MyBoundedShape with
...
public class MyOval extends MyBoundedShape {
	...
	public MyOval(int x1Coordinate, int y1Coordinate, int x2Coordinate, int y2Coordinate, Color color, boolean fill) {
	...
	public MyOval() {
		super(0, 0, 0, 0, Color.BLACK, false); // set all default coordinate values in the MyBoundedShape constructor to 0 and the colour to black
	...
	public void draw(Graphics g) {
		...
		if(getFill()){
			g.fillOval(getUpperLeftX(), getUpperLeftY(), getWidth(), getHeight()); // draw a filled-in rectangle using methods from superclass
		} else {
			g.drawOval(getUpperLeftX(), getUpperLeftY(), getWidth(), getHeight()); // draw a filled-in rectangle using methods from superclass
		} // end if statement
	} // end draw method
} // end class MyOval